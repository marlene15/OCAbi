                    ...
                    <div class="portlet-body form well">
                        ...
                        <div class="bs-example bs-example-tabs">
                            <ul class="nav nav-tabs" id="myTab">
                              <li class="active"><a data-toggle="tab" href="#comoVamos">ComoVamosColima</a></li>
                              <li class=""><a data-toggle="tab" href="#afmedios">Afmedios Noticias</a></li>
                              <li class=""><a data-toggle="tab" href="#angel">Ángel Guardián</a></li>
                              <li class=""><a data-toggle="tab" href="#soyNachista">soyNachista</a></li>
                            </ul>
                              <div class="tab-content" id="myTabContent">

                                <div id="comoVamos" class="tab-pane fade"> 
                                    <div class="container-fluid">
                                        <div class="row-fluid">
                                            <div class="span12">                                          
                                                <div data-fullscreen="false" data-title=".widget .widget-primary" data-icon="icon-facebook" class="widget widget-primary" id="graf">
                                                    ...
                                                    <div class="widget-content">    
                                                        <div class="container-fluid">
                                                            <div class="row-fluid">
                                                                <div class="span12">
                                                                    <h3>Total: <?php echo $totalCV; ?> comentarios</h3>
                                                                </div>
                                                            </div>
                                                        </div>                                      
                                                        <div class="container-fluid">
                                ...
                                <div id="afmedios" class="tab-pane active in">
                                    <div class="container-fluid">
                                        <div class="row-fluid">
                                            <div class="span12">                                          
                                                <div data-fullscreen="false" data-title=".widget .widget-primary" data-icon="icon-facebook" class="widget widget-primary" id="graf">
                                                    ...
                                                    <div class="widget-content">
                                                        <div class="container-fluid">
                                                            <div class="row-fluid">
                                                                <div class="span12">
                                                                    <h3>Total: <?php echo $totalFM; ?> comentarios</h3>
                                                                </div>
                                                            </div>
                                                        </div>                                           
                                                        <div class="container-fluid">
                                                ...
                                                <div data-fullscreen="false" data-title=".widget .widget-primary" data-icon="icon-facebook" class="widget widget-primary" id="graf">
                                                    ...
                                                    <div class="widget-content">
                                                        <div class="container-fluid">
                                                            <div class="row-fluid">
                                                                <div class="span12">
                                                                    <h3>Total: <?php echo $totalAG; ?> comentarios</h3>
                                                                </div>
                                                            </div>
                                                        </div>                                           
                                                        <div class="container-fluid">
                                ...
                                <div id="soyNachista" class="tab-pane">
                                    <div class="container-fluid">
                                        <div class="row-fluid">
                                            <div class="span12">                                          
                                                <div data-fullscreen="false" data-title=".widget .widget-primary" data-icon="icon-facebook" class="widget widget-primary" id="graf">
                                                    ...
                                                    <div class="widget-content"> 
                                                        <div class="container-fluid">
                                                            <div class="row-fluid">
                                                                <div class="span12">
                                                                    <h3>Total: <?php echo $totalSN; ?> comentarios</h3>
                                                                </div>
                                                            </div>
                                                        </div>                                          
                                                        <div class="container-fluid">
...
<script language="JavaScript">
    ...
    //Datos jorge
    loadLiquidFillGauge("fillgauge1", <?php echo $comoVamosP; ?>, config1);
    loadLiquidFillGauge("fillgauge2", <?php echo $comoVamosNe; ?>, config2);
    loadLiquidFillGauge("fillgauge3", <?php echo $comoVamosN; ?>, config3);
    //Datos nacho
    loadLiquidFillGauge("fillgauge4", <?php echo $afmediosP; ?>, config1);
    loadLiquidFillGauge("fillgauge5", <?php echo $afmediosNe; ?>, config2);
    loadLiquidFillGauge("fillgauge6", <?php echo $afmediosN; ?>, config3);
    //Datos martha
    loadLiquidFillGauge("fillgauge7", <?php echo $angelP; ?>, config1);
    loadLiquidFillGauge("fillgauge8", <?php echo $angelNE; ?>, config2);
    loadLiquidFillGauge("fillgauge9", <?php echo $angelN; ?>, config3);    
    //Datos locho
    loadLiquidFillGauge("fillgauge10", <?php echo $soyNachistaP; ?>, config1);
    loadLiquidFillGauge("fillgauge11", <?php echo $soyNachistaNe; ?>, config2);
    loadLiquidFillGauge("fillgauge12", <?php echo $soyNachistaN; ?>, config3);    
