                ...
                <div class="row-fluid">
                    <div class="span12" id="encabezado">
                        <h3 class="page-title" id="titulo">
                            Soy Nachista <small>Actividad en Facebook </small>
                        </h3>
                        <ul class="breadcrumb" id="ul_menu">
                            ...
                            <li>
                                <i class="icon-home"></i>
                                <a href="<?php echo site_url('facebook/controlador_inicio/afmedios'); ?>">Soy Nachista</a> 
                            </li>                           
                        </ul>    
                    </div>
                </div>
    ...
    $(document).ready(function(){                                        
      $("#consulta").click(function(event) {
        ...
        $.ajax({                                            
          type:"post",
          data:parametros,
          url: '<?php echo site_url('facebook/controlador_consultas/rango_soyNachista');?>',                                      
          dataType: 'html',
