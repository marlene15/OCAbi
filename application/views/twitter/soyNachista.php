                ...
                <div class="row-fluid">
                    <div class="span12" id="encabezado">
                        <h3 class="page-title" id="titulo">
                            SoyNachista <small>Actividad en Twitter </small>
                        </h3>
                        <ul class="breadcrumb" id="ul_menu">
                            ...
                            <li>
                                <i class="icon-home"></i>
                                <a href="<?php echo site_url('twitter/controlador_inicio/soyNachista'); ?>">SoyNachista</a> 
                            </li>                           
                        </ul>    
                    </div>
                </div>
    ...
    $(document).ready(function(){                                        
      $("#consulta2").click(function(event) {
        ...
        $.ajax({                                            
          type:"post",
          data:parametros,
          url: '<?php echo site_url('twitter/controlador_consultas/rango_soyNachista');?>',                                      
          dataType: 'html',
